            ...
            <List.Item key="1">
                <div style={{ width: '100%' }}>
                    <Row type="flex" gutter={{ xs: 8, sm: 16, md: 24 }}>
                        ...
                        <Col span={3} style={{ "display": "flex", "justifyContent": "start", marginTop: '1vh' }} >
                ...
                <div style={{ width: '100%' }}>
                    {
                        store.payments ? store.payments.map((payment) => {
                            return (<Row type="flex" gutter={{ xs: 8, sm: 16, md: 24 }} key={payment.id}  style = {payment.isCurrent == 1? {"color":"blue"} : {} } >
                                <Col span={3} style={{ "display": "flex", "justifyContent": "start", marginTop: '1vh' }} >缴费{paymentIndex++}：</Col>
                                ...
                                <Col span={3} style={{ "display": "flex", "justifyContent": "start", marginTop: '1vh' }} >商户订单号：</Col>
                                <Col span={3} style={{ "display": "flex", "justifyContent": "start", marginTop: '1vh' }} >
